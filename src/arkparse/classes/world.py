...
class SupplyCrates:
    ...
    _2_astraeos: str = "/Game/Mods/Astraeos/Assets/CoreBlueprints/HordeCrates/ElementWall_Horde_2_Astraeos.ElementWall_Horde_2_Astraeos_C"
    _3_astraeos: str = "/Game/Mods/Astraeos/Assets/CoreBlueprints/HordeCrates/ElementWall_Horde_3_Astraeos.ElementWall_Horde_3_Astraeos_C"
    astraeos: str = "/Game/Mods/Astraeos/Assets/CoreBlueprints/HordeCrates/ElementWall_Horde_Astraeos.ElementWall_Horde_Astraeos_C"
    supply_crate_base_bp_instantaneous_den_logs_child2: str = "/Game/Mods/Ragnarok/Custom_Assets/Environment/BeaverDam/SupplyCrateBaseBP_Instantaneous_DenLogs_Child2.SupplyCrateBaseBP_Instantaneous_DenLogs_Child2_C"

    all_bps = [element_wall_horde, element_wall_horde_2, element_wall_horde_3, _2_astraeos, _3_astraeos,
               astraeos, supply_crate_base_bp_instantaneous_den_logs_child2]

class ArtifactCrates:
    _2_ab: str = "/Game/Aberration/CoreBlueprints/ItemLootSets/SupplyCrate/ArtifactCrate_2_AB.ArtifactCrate_2_AB_C"
    _3_ab: str = "/Game/Aberration/CoreBlueprints/ItemLootSets/SupplyCrate/ArtifactCrate_3_AB.ArtifactCrate_3_AB_C"
    ab: str = "/Game/Aberration/CoreBlueprints/ItemLootSets/SupplyCrate/ArtifactCrate_AB.ArtifactCrate_AB_C"
    ...
    _2_se: str = "/Game/ScorchedEarth/CoreBlueprints/ItemLootSets/SupplyCrates/ArtifactCrate_2_SE.ArtifactCrate_2_SE_C"
    _3_se: str = "/Game/ScorchedEarth/CoreBlueprints/ItemLootSets/SupplyCrates/ArtifactCrate_3_SE.ArtifactCrate_3_SE_C"
    se: str = "/Game/ScorchedEarth/CoreBlueprints/ItemLootSets/SupplyCrates/ArtifactCrate_SE.ArtifactCrate_SE_C"

    all_bps = [_2_ab, _3_ab, ab, desert_kaiju_ex, forest_kaiju_ex, ice_kaiju_ex, artifact_crate_1,
               artifact_crate_10, artifact_crate_11, artifact_crate_2, artifact_crate_3, artifact_crate_4,
               artifact_crate_5, artifact_crate_6, artifact_crate_7, artifact_crate_8, artifact_crate_9,
               _2_se, _3_se, se]

class DroppedItems:
    dropped_item_generic_fertilized_egg_rock_drake: str = "/Game/Aberration/Dinos/RockDrake/DroppedItemGeneric_FertilizedEgg_RockDrake.DroppedItemGeneric_FertilizedEgg_RockDrake_C"
    dropped_item_generic_fertilized_egg_rock_drake_no_physics: str = "/Game/Aberration/Dinos/RockDrake/DroppedItemGeneric_FertilizedEgg_RockDrake_NoPhysics.DroppedItemGeneric_FertilizedEgg_RockDrake_NoPhysics_C"
    gacha_pod: str = "/Game/Extinction/Dinos/Gacha/DroppedItem_GachaPod.DroppedItem_GachaPod_C"
    dropped_item_generic_fertilized_egg_no_physics_cherufe: str = "/Game/Genesis/Dinos/Cherufe/DroppedItemGeneric_FertilizedEgg_NoPhysicsCherufe.DroppedItemGeneric_FertilizedEgg_NoPhysicsCherufe_C"
    dropped_item_generic: str = "/Game/PrimalEarth/Test/DroppedItemGeneric.DroppedItemGeneric_C"
    dropped_item_generic_fertilized_egg_no_physics_wyvern: str = "/Game/PrimalEarth/Test/DroppedItemGeneric_FertilizedEgg_NoPhysicsWyvern.DroppedItemGeneric_FertilizedEgg_NoPhysicsWyvern_C"
    dropped_item_generic_fertilized_egg_wyvern: str = "/Game/PrimalEarth/Test/DroppedItemGeneric_FertilizedEgg_Wyvern.DroppedItemGeneric_FertilizedEgg_Wyvern_C"
    dropped_item_generic_unfertilized_egg: str = "/Game/PrimalEarth/Test/DroppedItemGeneric_UnfertilizedEgg.DroppedItemGeneric_UnfertilizedEgg_C"

    all_bps = [dropped_item_generic_fertilized_egg_rock_drake,
               dropped_item_generic_fertilized_egg_rock_drake_no_physics, gacha_pod,
               dropped_item_generic_fertilized_egg_no_physics_cherufe, dropped_item_generic,
               dropped_item_generic_fertilized_egg_no_physics_wyvern,
               dropped_item_generic_fertilized_egg_wyvern, dropped_item_generic_unfertilized_egg]

class Nests:
    gigantoraptor_nest: str = "/Game/ASA/Dinos/Gigantoraptor/Nest/GigantoraptorNest.GigantoraptorNest_C"
    rock_drake_nest: str = "/Game/Aberration/Dinos/RockDrake/RockDrakeNest.RockDrakeNest_C"
    cherufe_nest: str = "/Game/Genesis/Dinos/Cherufe/CherufeNest.CherufeNest_C"
    wyvern_nest: str = "/Game/ScorchedEarth/Dinos/Wyvern/WyvernNest.WyvernNest_C"

    all_bps = [gigantoraptor_nest, rock_drake_nest, cherufe_nest, wyvern_nest]
...
class BossArenas:
    ...
    fz: str = "/Game/Extinction/CoreBlueprints/Tribute/BossArenaManager_FZ.BossArenaManager_FZ_C"
    ...
    all_bps = [rag_wyv_boss, rockwell, desert, fz, forest, snow, eel_boss_fight, cyclops, medusa, dragon,
               end_boss, gorilla, manticore, spider, two_bosses_spider_gorilla,
...
class Missions:
    ...
    patrols: str = "/Game/LostColony/CoreBlueprints/Patrols/NPCZoneManager_Patrols.NPCZoneManager_Patrols_C"
    ...
    all_bps = [gen_outpost_base, patrols, lc_bossfight, lc_overworld_base, npc_zone_manager_blueprint_cave,
               npc_zone_manager_blueprint_land, npc_zone_manager_blueprint_land_world_boss,
               npc_zone_manager_blueprint_water]

class DayCycles:
    aberration_day_cycle: str = "/Game/Aberration/CoreBlueprints/AberrationDayCycle.AberrationDayCycle_C"
    extinction_day_cycle: str = "/Game/Extinction/CoreBlueprints/ExtinctionDayCycle.ExtinctionDayCycle_C"
    day_cycle_manager_genesis: str = "/Game/Genesis/CoreBlueprints/Environment/DayCycleManager_Genesis.DayCycleManager_Genesis_C"
    lc: str = "/Game/LostColony/CoreBlueprints/Weather/LC_DayCycle.LC_DayCycle_C"
    day_cycle_manager_astraeos: str = "/Game/Mods/Astraeos/Assets/CoreBlueprints/DayCycleManager_Astraeos.DayCycleManager_Astraeos_C"
    rag: str = "/Game/Mods/Ragnarok/Custom_Assets/Weather/Systems/Rag_DayCycle.Rag_DayCycle_C"
    day_cycle_manager: str = "/Game/PrimalEarth/CoreBlueprints/DCM/DayCycleManager.DayCycleManager_C"
    scorched_earth_day_cycle: str = "/Game/ScorchedEarth/CoreBlueprints/Core/ScorchedEarthDayCycle.ScorchedEarthDayCycle_C"

    all_bps = [aberration_day_cycle, extinction_day_cycle, day_cycle_manager_genesis, lc,
               day_cycle_manager_astraeos, rag, day_cycle_manager, scorched_earth_day_cycle]

class Vehicles:
    portable_rope_ladder: str = "/Game/Packs/Steampunk/Dinos/Zeppelin/PortableRope_Ladder_Zeppelin.PortableRope_Ladder_Zeppelin_C"
    portable_rope_ladder_back: str = "/Game/Packs/Steampunk/Dinos/Zeppelin/PortableRope_Ladder_Zeppelin_Back.PortableRope_Ladder_Zeppelin_Back_C"
    ...
    all_bps = [portable_rope_ladder, portable_rope_ladder_back, car_vehicle_bp, motor_raft_bp, raft_bp,
               brig_ship_player_following_bp_miniboss]
